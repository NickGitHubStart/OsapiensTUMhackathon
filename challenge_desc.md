...
## ðŸš€ osapiens Challenge: Detecting Deforestation from Space

What if you could be certain that the coffee youâ€™re enjoying didnâ€™t come at the cost of cutting down trees older than you?
...
### ðŸ§° What Youâ€™ll Have Access To
...
Additionally, there is a live leaderboard during the hackathon that compares the performance of each teamâ€™s predictions on a hidden test set. Keep in mind that the ultimate ranking will be determined by a combination of quantitative performance and qualitative evaluation by the jury, so focus on building a strong overall solution rather than just optimizing for the leaderboard.
